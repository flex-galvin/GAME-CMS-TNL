                ...
                <UCard class="w-full">
                  <UiFlex class="gap-6 pt-[25px]">
                    <UiText 
                      ...
                      "
                    >
                      <span class="text-gradient">{{ toMoney(row.need) }} {{ t('coin') }}</span>
                    </UiText>
...
const tab = ref(0)
const tabs = [
  { label: t('day'), key: 'spend.day.coin' },
  { label: t('month'), key: 'spend.month.coin' },
  { label: t('total'), key: 'spend.total.coin' },
]
