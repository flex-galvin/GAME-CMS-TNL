<template>
  <UiContent :title="t('limitedMonsterTopReceive')" :sub="t('limitedMonsterTopReceiveSub')" class="Monster rounded-2xl p-4">
...
const submit = async () => {
  try {
    ...
    await useAPI('limited/monster/public/top/receive', state.value)
