<template>
  <UiContent :title="t('limitedHalloweenTopReceive')" :sub="t('limitedHalloweenTopReceiveSub')" class="Halloween rounded-2xl p-4">
...
const submit = async () => {
  try {
    ...
    await useAPI('limited/halloween/public/top/receive', state.value)
