<template>
  <UiContent :title="t('menuManageItemBox')" :sub="t('menuManageItemBoxInfo')">
    <UiFlex class="gap-1">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('item/box/manage/list', page.value)
...
const addAction = async () => {
  try {
    ...
    await useAPI('item/box/manage/add', stateAdd.value)
...
const editAction = async () => {
  try {
    ...
    await useAPI('item/box/manage/edit', stateEdit.value)
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('item/box/manage/del', { _id })
