<template>
  <UiContent :title="t('menuManageAdsFrom')" :sub="t('menuManageAdsFromInfo')">
    <UiFlex class="gap-1">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('ads/from/manage/list', page.value)
...
const addAction = async () => {
  try {
    ...
    await useAPI('ads/from/manage/add', stateAdd.value)
...
const editAction = async () => {
  try {
    ...
    await useAPI('ads/from/manage/edit', stateEdit.value)
