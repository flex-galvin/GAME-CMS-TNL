<template>
  <UiContent :title="t('menuManageNewsCategory')" :sub="t('menuManageNewsCategoryInfo')">
    <UiFlex class="gap-1">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('news/manage/category/list', page.value)
...
const addAction = async () => {
  try {
    ...
    await useAPI('news/manage/category/add', stateAdd.value)
...
const editAction = async () => {
  try {
    ...
    await useAPI('news/manage/category/edit', stateEdit.value)
